...
const SignUp = () => {
  ...
  return (
    <div className={styles.main}>
        <div >
            <p  style={{marginLeft:"30px"}} className={styles.heading}>PERSONAL DETAILS</p>
              
              <div style={{marginLeft:"30px"}}>
                <span><input type="radio" />&nbsp;  PERSONAL</span> &nbsp; &nbsp; &nbsp; &nbsp;<span><input type="radio" />  &nbsp;COMPANY</span>
              </div>
         
            <div className={styles.input_wrap}>
                <br/>
                
                <input style={{width:"400px"}} className={styles.inputText} 
            ...
            <div className={styles.btnDiv}>
                <input style={{width:"400px"}} className={styles.submitBtn} onClick={handleSignUp}
                type='submit'
